#ifndef __MSS_MUSCLE_LIMIT_CONSTRAINT_H__
#define __MSS_MUSCLE_LIMIT_CONSTRAINT_H__
...
public:
  /// Constructor
  explicit MuscleLimitConstraint(MSS::Muscle* muscle);
  ...
  MSS::Muscle* GetMuscle(){return mMuscle;}
