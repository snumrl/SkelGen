...
double scaleParmMuscle = 1.5;
double scaleIndexMuscle = 0;
double scaleCoeffMuscle = (scaleParmMuscle *scaleIndexMuscle +1.0*(3.0-scaleIndexMuscle))/3.0;
...
Muscle(std::string _name,double _f0,double _lm0,double _lt0,double _pen_angle,double lmax)
	:name(_name),f0(_f0*2.0*scaleParmMuscle),l_m0(1.0),l_m(l_mt - l_t0),l_t0(0.2),l_mt0(0.0),l_mt(1.0),activation(0.0),f_toe(0.33),k_toe(3.0),k_lin(51.878788),e_toe(0.02),e_t0(0.033),k_pe(4.0),e_mo(0.6),gamma(0.5),l_mt_max(lmax)
{
}
...
//	std::cout<<JtA.transpose()<<std::endl;
	num_related_dofs = 0;
