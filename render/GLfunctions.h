...
namespace GUI
{
	/// Visualize active force
	void DrawCapsule(const Eigen::Vector3d& p0,const Eigen::Vector3d& p1, const double thickness, const double activation);
	/// Visualize passive force
	void DrawCapsule2(const Eigen::Vector3d& p0,const Eigen::Vector3d& p1, const double thickness, const double passiveForce);
